        ...
        <div class="table-responsive col-sm-10">
            <table class="table table-condensed">
                ...
                <tr>
                    ...
                    <td>order Date</td>
                    <%
                        com.LiuJunwei.model.Order o=(com.LiuJunwei.model.Order)pageContext.findAttribute("o");
                        int userId=o.getCustomerId();
                        java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
                        com.LiuJunwei.dao.UserDao userDao=new com.LiuJunwei.dao.UserDao();
                    ...
                    <td class="cart_total">
                        <%
                            ...
                            String paymentType=com.LiuJunwei.model.Payment.findByPaymentId(con,n);
                        %>
